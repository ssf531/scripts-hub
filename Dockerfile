...
COPY src/SmartScript.Api/SmartScript.Api.csproj src/SmartScript.Api/
...
RUN dotnet publish src/SmartScript.Api/SmartScript.Api.csproj -c Release -o /app/publish --no-restore
...
ENTRYPOINT ["dotnet", "SmartScript.Api.dll"]
